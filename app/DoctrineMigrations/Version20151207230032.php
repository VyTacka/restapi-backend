 ...
 */
class Version20151207230032 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE drink (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, packaging_capacity INT NOT NULL, packaging_amount INT NOT NULL, packaging_price DOUBLE PRECISION NOT NULL, alc_vol DOUBLE PRECISION NOT NULL, rating SMALLINT NOT NULL, note LONGTEXT NOT NULL, INDEX IDX_DBE40D1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
